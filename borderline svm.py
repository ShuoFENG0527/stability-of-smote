...
class stable_SMOTE:
    ...
    def fit_sample(self, x_dataset, y_dataset):
        ...
        # copy_dataset = np.array(x_dataset)
        ...
        if involve_defective_number == 0:
            ...
            return result
        number_on_each_instance = need_number / involve_defective_number  # 每个实例分摊到了生成几个的任务
        total_pair = []
...
auc_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'auc_borderline_result_on_'+classifier+'.csv', 'w', newline='')
auc_writer = csv.writer(auc_file)
auc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

balance_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'balance_borderline_result_on_'+classifier+'.csv', 'w', newline='')
balance_writer = csv.writer(balance_file)
balance_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

recall_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'recall_borderline_result_on_'+classifier+'.csv', 'w', newline='')
recall_writer = csv.writer(recall_file)
recall_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

pf_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'pf_borderline_result_on_'+classifier+'.csv', 'w', newline='')
pf_writer = csv.writer(pf_file)
pf_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max"])

brier_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'brier_borderline_result_on_'+classifier+'.csv', 'w', newline='')
brier_writer = csv.writer(brier_file)
brier_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

mcc_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'mcc_borderline_result_on_'+classifier+'.csv', 'w', newline='')
mcc_writer = csv.writer(mcc_file)
mcc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_auc_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'auc_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
stable_auc_writer = csv.writer(stable_auc_file)
stable_auc_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_balance_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'balance_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_recall_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'recall_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_pf_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'pf_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
stable_pf_writer = csv.writer(stable_pf_file)
stable_pf_writer.writerow(["inputfile", "", "", "", "", "", "", "", "", "", "", "min", "lower", "avg", "median", "upper", "max", "variance"])

stable_brier_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'brier_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
...
stable_mcc_file = open('D:\\investigation on the stability revision\\k value\\borderline\\'+str(neighbor)+'mcc_stable_borderline_result_on_'+classifier+'.csv', 'w',
              newline='')
...
for inputfile in os.listdir("D:\\datasets\\all\\all\\"):
    ...
    for j in range(10):
        ...
        for s in range(10):
            smote = SMOTE(k_neighbors=neighbor, kind="borderline1")
